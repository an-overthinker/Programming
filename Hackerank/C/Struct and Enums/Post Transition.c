...
{   
    ...
    for (package=0; package < source_office_packages; package++) {
...
Town* town_with_most_packages(const Town* towns, const int towns_count)
{
    ...
    for (town=0; town < towns_count; town++) {
        packages_in_town = 0;
        offices_count = towns[town].offices_count;
        
        for (office=0; office < offices_count; office++)
...
void print_all_packages(const Town* town)
{
    int package,office;
    printf("%s:\n", town->name);
    for (office=0; office < town->offices_count; office++)
	{
        printf("\t%d:\n", office);
        for (package = 0; package < town->offices[office].packages_count; package++)
...
int main() {
    int towns_count,town;
    int offices_count,office;
    int packages_count,package;
    ...
    for (town = 0; town < towns_count; town++) {    
        ...
        for (office=0; office < offices_count; office++) {
            ...
            for (package=0; package < packages_count; package++) {
