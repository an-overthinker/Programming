...
char* get_word(char* text, int beg, int end) //returns the word between beg and end
{
    char* answer;
...
char** get_sentence(char* text, int beg, int end) //returns the sentence between beg and end
{
    char** answer;
    int word_count = 1;
    int i;
...
char*** get_paragraph(char* text, int beg, int end) //returns the paragraph between beg and end
{
    char*** answer;
